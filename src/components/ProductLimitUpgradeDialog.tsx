...
interface ProductLimitUpgradeDialogProps {
  isOpen: boolean;
  onClose: () => void;
  currentLimit: number;
  newLimit: number;
...
export function ProductLimitUpgradeDialog({ isOpen, onClose, currentLimit, newLimit }: ProductLimitUpgradeDialogProps) {
        ...
        <div className="px-4 py-3 flex-1">
          ...
          <div className="space-y-2 pl-4">
            <div className="flex items-center py-1">
              <span className="font-medium text-base w-36">Feature</span>
              <span className="text-base ml-4 text-orange-500">
                Product limit（{currentLimit}→{newLimit}）
              </span>
            </div>

            <div className="flex items-center py-1">
              <span className="font-medium text-base w-36">Plan</span>
              <div className="ml-4">
            ...
            <div className="flex items-center py-1">
              <span className="font-medium text-base w-36 whitespace-nowrap">Payment Method</span>
